...
function setup() {
    ...
    let height = parseFloat(body.style('width'))*0.5014;
    if(height > parseFloat(body.style('height'))){
        document.querySelector('main').style.height = body.style('height');
        document.querySelector('main').style.width = (parseFloat(body.style('height')) * 2).toString() + "px";
        console.log((parseFloat(body.style('height')) * 2).toString());
    }
    else {
        document.querySelector('main').style.height = height.toString() + "px";
        document.querySelector('main').style.width = body.style('width');
