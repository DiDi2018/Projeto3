...
<map name="monstro1map" id="areaMonstro1">
    <area id="areaMonstro1" shape="poly" alt="image" onmouseover="mouseOverMonstro1()" onmouseout="mouseLeftMonstro1()" onclick="playaudio1()"
...
<map name="monstro2map">
    <area id="areaMonstro2" shape="poly" alt="image" onmouseover="mouseOverMonstro2()" onmouseout="mouseLeftMonstro2()" onclick="playaudio2()"
